<template>
    <v-container>
        <v-row>
            ...
            <v-col class="my-auto">
                <v-img  aspect-ratio="16/9" cover src="../assets/About_Us.png"></v-img>
            </v-col>
        </v-row>
...
export default {
    ...
    data: () => ({
        title: "About us",
        desctiption: "What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's" +
